          ...
          children: [
            IconButton(
              ...
              icon: Icon(
                ...
                size: 30,
                color: cuttentIndex == 0 ? Colors.blue : Colors.grey.shade400,
              ),
            ),
            IconButton(
              onPressed: () {
              ...
              icon: Icon(
                ...
                size: 30,
                color: cuttentIndex == 1 ? Colors.blue : Colors.grey.shade400,
              ),
            ),
            const SizedBox(
              width: 15,
            ...
            IconButton(
              ...
              icon: Icon(
                ...
                size: 30,
                color: cuttentIndex == 3 ? Colors.blue : Colors.grey.shade400,
              ),
            ),
            IconButton(
              onPressed: () {
              ...
              icon: Icon(
                Icons.person,
                size: 30,
                color: cuttentIndex == 4 ? Colors.blue : Colors.grey.shade400,
              ),
            ),
          ],
        ),
